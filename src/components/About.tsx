        ...
        <section className="items-center justify-center bg-lightPrimary dark:bg-darkSecondary" id="about">
            <div className="max-w-7xl w-5/6 py-20 m-auto">
                ...
                <p className="text-lg pt-5">
                    I am a fullstack developer with +3 years of experience with fast learning capacity and willingness to face different challenges.
                ...
                <div className="flex flex-col gap-10 lg:flex-row pt-10">
                    <div className='lg:w-1/3'>
                        <h2 className="subtitle py-5">🖥️ Experience<span className="text-info">.</span></h2>
                        <Experience />
                    </div>
                    <div className='lg:w-2/3'>
                        <h2 className="subtitle py-5">🛠️ Skills<span className="text-info">.</span></h2>
